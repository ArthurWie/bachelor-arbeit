...
interacting, and problem solving'' (Raisch \& Krakowski, 2021, p.~192),
...
(Lui, Lee, \& Ngai, 2022, as cited in Kemp, 2024, p.~619).

Theory can make sense of this disconnect. AI ``is regarded as a general-purpose technology akin
to electricity, the steam engine, or the internet'' (Kemp, 2024, p.~620),
...
1991, p.~110). The advantage goes to the firm that combines the
technology with resources others cannot copy, such as its social relations
and culture (Barney, 1991, p.~110). This thesis asks under what conditions firms
...
Hodson (2024, p.~1) find higher growth and more product innovation among
AI-investing firms, concentrated among firms that were already large (Babina
et al., 2024, p.~3). Brynjolfsson, Rock, and Syverson (2021, p.~334)
...
retrained staff and reorganized workflows. Lui, Lee, and Ngai (2022, p.~373)
...
p.~1709). The same review concedes that ``it is still not
clear if and how AI can help organizations achieve financial performance
gains'' (Enholm et al., 2022, p.~1728). This thesis aims to close that gap. It collects and
